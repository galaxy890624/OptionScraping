...
from Delta import fetch_options_data, get_spot_price_taifex, calculate_delta, current_time, datetime, spot_price
...
def home():
    ...
    return render_template('Index.html', current_time=current_time, spot_price = spot_price)
